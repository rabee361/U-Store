...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const showButtons = document.querySelectorAll('.btn-theme-show');
    const buyButtons = document.querySelectorAll('.btn-theme-buy');
    ...
    showButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            // 👁️ Show theme preview (placeholder functionality)
            console.log(`🎨 عرض معاينة للثيم: ${themeTitle}`);
            
            // You can add modal or redirect logic here
            // Example: window.open('/theme-preview/' + themeId, '_blank');
        });
    });
    ...
    buyButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            const themeCard = this.closest('.theme-card');
            const themeTitle = themeCard.querySelector('.theme-title').textContent;
            const themePrice = themeCard.querySelector('.theme-price').textContent;
            
            // 🛒 Handle theme purchase (placeholder functionality)
            console.log(`💰 شراء الثيم: ${themeTitle} بسعر ${themePrice}`);
            
            // You can add purchase logic here
            // Example: addToCart(themeId) or redirectToCheckout(themeId)
        });
    });
